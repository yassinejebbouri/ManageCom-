...
var _rawData = _interopRequireDefault(require("./data/rawData.js"));

var _markdownValues = _interopRequireDefault(require("./data/markdownValues.js"));
...
describe('stateFromMarkdown', function () {
  it('should create content state', function () {
    ...
    var contentState = (0, _stateFromMarkdown["default"])(markdown);
  ...
  it('should correctly handle images with alt text', function () {
    ...
    var rawContentState = (0, _draftJs.convertToRaw)(contentState);
    var blocks = removeKeys(rawContentState.blocks);
    (0, _expect["default"])(_objectSpread({}, rawContentState, {
      blocks: blocks
    })).toEqual({
  ...
  it('should correctly parse italic words with markdown', function () {
    var contentState = (0, _stateFromMarkdown["default"])(_markdownValues["default"].italicTest);
    var rawContentState = (0, _draftJs.convertToRaw)(contentState);
    var blocks = removeKeys(rawContentState.blocks);
    (0, _expect["default"])([_rawData["default"].italicTest]).toEqual(blocks);
  });
  it('should correctly parse italic and bold words with markdown', function () {
    var contentState = (0, _stateFromMarkdown["default"])(_markdownValues["default"].italicAndBoldTest);
    var rawContentState = (0, _draftJs.convertToRaw)(contentState);
    var blocks = removeKeys(rawContentState.blocks);
    (0, _expect["default"])([_rawData["default"].italicAndBoldTest]).toEqual(blocks);
  });
  it('should correctly parse italic words with the "_" character in markdown', function () {
    var contentState = (0, _stateFromMarkdown["default"])(_markdownValues["default"].italicEscapeUnderscoreChar);
    var rawContentState = (0, _draftJs.convertToRaw)(contentState);
    var blocks = removeKeys(rawContentState.blocks);
    (0, _expect["default"])([_rawData["default"].italicEscapeUnderscoreChar]).toEqual(blocks);
  });
  it('should correctly parse italic and Bold words with the "*" character in markdown', function () {
    var contentState = (0, _stateFromMarkdown["default"])(_markdownValues["default"].italicEscapeBoldChar);
    var rawContentState = (0, _draftJs.convertToRaw)(contentState);
    var blocks = removeKeys(rawContentState.blocks);
    (0, _expect["default"])([_rawData["default"].italicEscapeBoldChar]).toEqual(blocks);
  });
});
