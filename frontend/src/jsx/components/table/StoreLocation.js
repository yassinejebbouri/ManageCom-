...
const StoreLocationTable = () => {
  ...
  const [storeLocationModal, setStoreLocationModal] = React.useState(false);

  return (
    <Fragment>
      <StoreLocationModal
        edit={true}
        active={storeLocationModal}
        onClick={() => setStoreLocationModal(false)}
      />
          <PageTitle activeMenu="Store Location" motherMenu="Data Management" />
          <div className="row">
